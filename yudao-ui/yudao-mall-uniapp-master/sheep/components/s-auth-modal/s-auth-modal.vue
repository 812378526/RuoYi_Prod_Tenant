    ...
    <view class="login-wrap">
      ...
      >
        ...
        <view class="agreement-options-container">
          <!-- 同意选项 -->
          <view class="agreement-option ss-m-b-20" @tap="onAgree">
            <view class="custom-radio ss-flex ss-col-center ss-row-center" :class="{ checked: state.protocol === true }">
              <view v-if="state.protocol === true" class="custom-radio-inner" />
            </view>
          ...
          <!-- 拒绝选项 -->
          <view class="agreement-option" @tap="onRefuse">
            <view class="custom-radio ss-flex ss-col-center ss-row-center" :class="{ checked: state.protocol === false, refuse: state.protocol === false }">
              <view v-if="state.protocol === false" class="custom-radio-inner" />
            </view>
            <view class="agreement-text ss-flex ss-col-center ss-m-l-8">
              我拒绝遵守
              <view class="tcp-text" @tap.stop="onProtocol('用户协议')"> 《用户协议》 </view>
